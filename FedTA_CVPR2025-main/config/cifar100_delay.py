...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--dataset', default='svhn-mnist', type=str, help='dataset name')
    ...
    subparsers.add_argument('--global_epoch', default=5, type=int, nargs="+",
                            help='the num of client')
    subparsers.add_argument('--local_epoch', default=30, type=int, nargs="+",
                            help='the num of client')
    subparsers.add_argument('--threshold', default=0.15, type=int, nargs="+",
                            help='the num of client')
    subparsers.add_argument('--data_name',default='cifar100',type=str)
